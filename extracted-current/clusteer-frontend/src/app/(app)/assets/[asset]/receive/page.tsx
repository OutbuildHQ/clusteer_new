...
const ADDRESSES: Record<string, Record<string, string>> = {
	...
	USDT: { Tron: "TXfM9pA2kL8c6D4wQ3rX5zYH8m2bN9J1fA", Ethereum: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e", BSC: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e" },
	USDC: { Ethereum: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e", Polygon: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e", Solana: "8vEWcqJQhM5xT9vYqZ6Nk4H3dKgP1mNrT" },
	SOL: { Solana: "8vEWcqJQhM5xT9vYqZ6Nk4H3dKgP1mNrT" },
	BNB: { BSC: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e" },
};
...
export default function ReceivePage({ params }: { params: Promise<{ asset: string }> }) {
	...
	const address = ADDRESSES[a.symbol]?.[network] ?? "bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq";
