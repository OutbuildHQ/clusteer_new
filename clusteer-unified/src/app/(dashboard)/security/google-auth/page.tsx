		...
		() => ({
			"bind-new-authenticator": (
				<div className="lg:max-w-[533px] mt-5">
					...
					<button
						onClick={goNext}
						style={{ height: 44, width: "100%", borderRadius: 10, fontSize: 16, fontWeight: 600, border: "1px solid black", background: "var(--c-lime-500)", color: "#111111", cursor: "pointer", marginTop: 30 }}
					>
						Next
					</button>
				</div>
		...
		<section className="mt-5 lg:mt-10 pb-[113px] xl:pb-[140px]">
			<header>
				<div className="flex gap-x-5 items-center py-5 border-b lg:py-0 lg:border-b-0 border-[#21241D33]">
					<button
						onClick={goBack}
						style={{ padding: 0, width: 24, height: 24, border: "none", background: "transparent", cursor: "pointer", color: "var(--c-text)" }}
					>
