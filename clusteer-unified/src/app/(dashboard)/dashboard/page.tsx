		...
		<div className="space-y-6">
			<header className="flex flex-wrap items-end justify-between gap-4">
				...
				<div className="flex gap-2">
					<Button asChild variant="outline" size="sm"><Link href="/receive"><ArrowDownToLine className="size-4" /><span className="hidden sm:inline">Receive</span></Link></Button>
					<Button asChild variant="outline" size="sm"><Link href="/send"><ArrowUpRight className="size-4" /><span className="hidden sm:inline">Send</span></Link></Button>
					<Button asChild size="sm"><Link href="/trade"><ArrowLeftRight className="size-4" /><span className="hidden sm:inline">Trade</span></Link></Button>
				</div>
			</header>
