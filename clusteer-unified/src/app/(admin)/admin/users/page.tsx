...
import { Search, Download, MoreHorizontal, Eye, Ban, CheckCircle, RotateCcw } from "lucide-react";
									...
									<TableCell>
										<DropdownMenu>
											...
											<DropdownMenuContent align="end">
												<DropdownMenuItem onClick={() => toast.info("Viewing user details...")}>
													<Eye className="size-4" />View details
												</DropdownMenuItem>
												<DropdownMenuSeparator />
												<DropdownMenuItem onClick={() => toast.warning("User suspended")}>
													<Ban className="size-4" />Suspend user
												</DropdownMenuItem>
												<DropdownMenuItem onClick={() => toast.success("User activated")}>
													<CheckCircle className="size-4" />Activate user
												</DropdownMenuItem>
												<DropdownMenuSeparator />
												<DropdownMenuItem onClick={() => toast.info("KYC status reset")}>
													<RotateCcw className="size-4" />Reset KYC
												</DropdownMenuItem>
											</DropdownMenuContent>
										</DropdownMenu>
									</TableCell>
