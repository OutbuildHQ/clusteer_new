		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
				<div className="bg-white rounded-lg border border-[#E9EAEB] p-6">
					...
					<h3 className="text-sm text-gray-600 font-medium mb-1">Total Users</h3>
				...
				<div className="bg-white rounded-lg border border-[#E9EAEB] p-6">
					...
					<h3 className="text-sm text-gray-600 font-medium mb-1">Active Users</h3>
				...
				<div className="bg-white rounded-lg border border-[#E9EAEB] p-6">
					...
					<h3 className="text-sm text-gray-600 font-medium mb-1">New Users</h3>
				...
				<div className="bg-white rounded-lg border border-[#E9EAEB] p-6">
					...
					<h3 className="text-sm text-gray-600 font-medium mb-1">Avg Session</h3>
				...
				<div className="flex items-center gap-3">
					<div className="flex-1 relative">
						...
						<input
							...
							className="w-full pl-10 pr-4 py-2.5 border border-[#E9EAEB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#014F01] focus:border-transparent"
						/>
					</div>
					<select
						value={statusFilter}
						onChange={(e) => setStatusFilter(e.target.value as any)}
						className="px-4 py-2.5 border border-[#E9EAEB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#014F01] focus:border-transparent"
					>
						...
						<tbody className="divide-y divide-[#E9EAEB]">
							{filteredUsers.map((user) => (
								...
								>
									...
									<td className="py-4 px-6">
										<span className="text-sm text-gray-600">{user.avgSessionDuration}</span>
									</td>
									<td className="py-4 px-6">
										<div className="flex items-center gap-2">
											<Smartphone className="w-4 h-4 text-gray-400" />
											<span className="text-sm text-gray-600">{user.deviceType}</span>
										</div>
									</td>
									<td className="py-4 px-6">
										<div className="flex items-center gap-2">
