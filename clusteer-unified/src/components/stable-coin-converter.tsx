	...
	return (
		<div className="relative flex md:flex-col mx-auto w-fit">
			...
			<div className="flex flex-col md:flex-row justify-center items-center gap-y-3.5 md:gap-x-[55px]">
				<div className="flex items-center h-[59px] max-w-[261px] md:max-w-[320px] gap-x-2 md:gap-x-2.5 rounded-full border-[0.52px] border-border focus-visible:ring-0 outline-none overflow-hidden">
