...
const LINKS = [
	...
	{ href: "/admin/kyc", label: "KYC queue", icon: ShieldCheck, badge: pendingKycCount > 0 ? String(pendingKycCount) : undefined },
	{ href: "/admin/wallets", label: "Wallets", icon: Wallet },
	{ href: "/admin/transactions", label: "Transactions", icon: ArrowLeftRight, badge: flaggedTxnCount > 0 ? String(flaggedTxnCount) : undefined },
