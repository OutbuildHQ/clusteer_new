...
const MobileTabBar = dynamic(
	() => import("@/components/app/mobile-tab-bar").then((m) => m.MobileTabBar),
	{ ssr: false }
);
...
const FlowHost = dynamic(() => import("@/components/flow-host").then((m) => m.FlowHost), {
	ssr: false,
});
	...
	return (
		<ThemeProvider>
			<div className="flex min-h-[100dvh]" style={{ background: "var(--c-bg)" }}>
				...
				>
					<TopBar />
					<main className="flex-1 overflow-auto px-4 py-4 pb-28 lg:px-9 lg:py-8 lg:pb-12">
