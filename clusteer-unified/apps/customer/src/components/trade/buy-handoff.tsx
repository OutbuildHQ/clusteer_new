		...
		<div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
			...
			<div style={{ textAlign: "center" }}>
				...
				<p style={{ fontSize: 13, color: "var(--c-text-2)", marginTop: 4 }}>
					Example details only. Do not send money.
				</p>
			</div>
			...
			<div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
				...
				<CopyField
					label="Amount"
					value={`₦${pd.amountNgn.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`}
				/>
			...
			>
				...
				<p style={{ fontSize: 12, color: "var(--c-text-2)", lineHeight: 1.5, margin: 0 }}>
					Use the <strong>exact amount</strong> and <strong>reference code</strong>. Incorrect
					details may delay or fail the order.
				</p>
			</div>
